...
class QueuePlayer(Player):
    def __init__(self, client: Type[Client], channel: VoiceChannel):
        ...
        self.message: discord.Messagable = None

        self.current_vote:bool = False
        self.votes = set()

    def get_thumbnail(self, track:Track) -> Union[str, discord.embeds._EmptyEmbed]:
    ...
    async def skip(self):
        ...
        embed.set_thumbnail(url=self.get_thumbnail(self.current))
